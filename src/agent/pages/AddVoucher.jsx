        ...
        <form className='scrollable-form' onSubmit={handleSubmit}>
          <div className="row mb-3">
            <div className="col-12">
              <label htmlFor="itemName" className='labelText'>Item Name<span className="required-star">*</span></label>
              <input type="text" id="itemName" name="itemName" className="form-control" placeholder="Item Name" value={formData.itemName} onChange={handleInputChange} required />
            </div>
          </div>
          ...
          <div className="row mb-3">
            <div className="col-12 col-md-4">
              ...
              <select id="itemShape" name="itemShape" className="form-control" value={formData.itemShape} onChange={handleInputChange}>
            ...
            <div className="col-12 col-md-4">
              ...
              <select id="itemColor" name="itemColor" className="form-control" value={formData.itemColor} onChange={handleInputChange}>
          ...
          <div className="row mb-3">
            <div className="col-12 col-md-6">
              ...
              <input type="number" id="quantity" name="quantity" className="form-control" placeholder="Quantity" value={formData.quantity} onChange={handleInputChange} />
            </div>
            <div className="col-12 col-md-6">
              <label className='labelText' htmlFor="purchasePrice">Purchase Price</label>
              <input type="number" id="purchasePrice" name="purchasePrice" className="form-control" placeholder="Purchase Price" value={formData.purchasePrice} onChange={handleInputChange} />
            </div>
          </div>
          ...
          <div className="row mb-3">
            <div className="col-12">
              ...
              <textarea id="remark" name="remark" className="form-control" placeholder="Remark" value={formData.remark} onChange={handleInputChange}></textarea>
            </div>
          </div>
