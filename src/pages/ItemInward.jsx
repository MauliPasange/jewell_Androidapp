...
export default function ItemInward() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        one: form.itemId || null,
        two: form.shapeId || null,
        three: form.colorId || null,
        four: form.subItemName || "null",
        five: form.voucherNo || "null",
        six: form.length || "null",
        seven: form.breadth || "null",
        eight: form.height || "null",
        nine: form.quantity || "null",
        ten: form.unit || "null",
        eleven: form.hsnCode || "null",
        twelve: "null",
        thirteen: form.purchasePrice ? parseFloat(form.purchasePrice) : null,
        fourteen: form.purchaseCode || "null",
        fifteen:form.salePrice ? parseFloat(form.salePrice) : null,
        sixteen: form.saleCode || "null",
        seventeen: form.supplierId || "null",
        eighteen: form.remarks || "null",
